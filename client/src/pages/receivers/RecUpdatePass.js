...
import { recAccount, recUpdatePassword } from "../../actions/user";
...
const RecUpdatePass = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!password.currentPass || !password.newPass || !password.verifyPass) {
      ...
      try {
        await dispatch(recUpdatePassword(id, password));
        setModalOpen(true);
